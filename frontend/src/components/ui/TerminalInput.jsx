...
const TerminalInput = ({ label, icon: Icon, onIconClick, id, ...props }) => (
  <div className="space-y-2 group">
    ...
    <div className="relative">
      ...
      />
      {Icon && <Icon size={18} onClick={onIconClick} className="absolute right-4 top-1/2 -translate-y-1/2 opacity-20 group-focus-within:opacity-60 transition-opacity" />}
    </div>
  </div>
);
